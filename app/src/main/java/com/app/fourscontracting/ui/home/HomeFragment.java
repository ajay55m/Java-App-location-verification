    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mWebView.addJavascriptInterface(new Object() {
            ...
            public void showFooter(final boolean visible) {
                final android.app.Activity activity = getActivity();
                if (activity instanceof WebviewActivity && isAdded()) {
                    activity.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
            ...
            mWebView.setOnScrollChangeListener(new View.OnScrollChangeListener() {
                ...
                public void onScrollChange(View v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                    if (getActivity() instanceof WebviewActivity) {
                        ((WebviewActivity) getActivity()).setHeaderCollapsed(scrollY > 15);
                    }
                }
            });
        }
        ...
        if (uid.isEmpty() || uid.equals("0")) {
            ...
            String url = "https://4scontracting.com/SMCS_APP/subcontractor/leaveform.php"
                    + "?uid=" + encUid
                    + "&id=" + encUid
